...
Build Streakify from the source and intsall dependencies:

1. **Clone the repository:**

    ```sh
    ❯ git clone https://github.com/ViktorKaderabek/Streakify
    ```
...
Streakify uses the {__test_framework__} test framework. Run the test suite with:
...
- **💬 [Join the Discussions](https://github.com/ViktorKaderabek/Streakify/discussions)**: Share your insights, provide feedback, or ask questions.
- **🐛 [Report Issues](https://github.com/ViktorKaderabek/Streakify/issues)**: Submit bugs found or log feature requests for the `Streakify` project.
- **💡 [Submit Pull Requests](https://github.com/ViktorKaderabek/Streakify/blob/main/CONTRIBUTING.md)**: Review open PRs, and submit your own PRs.
...
<br>
<p align="left">
   <a href="https://github.com{/ViktorKaderabek/Streakify/}graphs/contributors">
      <img src="https://contrib.rocks/image?repo=ViktorKaderabek/Streakify">
   </a>
</p>
</details>
...
Streakify is protected under the [LICENSE](https://choosealicense.com/licenses) License. For more details, refer to the [LICENSE](https://choosealicense.com/licenses/) file.
